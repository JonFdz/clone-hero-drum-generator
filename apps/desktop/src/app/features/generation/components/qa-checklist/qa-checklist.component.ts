...
@Component({
	selector: "chdg-qa-checklist",
	standalone: true,
	changeDetection: ChangeDetectionStrategy.OnPush,
	imports: [CommonModule, RouterModule],
	templateUrl: "./qa-checklist.component.html",
	styleUrl: "./qa-checklist.component.css",
})
export class QaChecklistComponent {
	@Input({ required: true }) summary!: ValidationSummary;
	@Input({ required: true }) rows!: ChecklistRow[];
	@Input({ required: true }) filter!: ChecklistFilter;
	@Input() hasOnlyInfoChecks = false;
