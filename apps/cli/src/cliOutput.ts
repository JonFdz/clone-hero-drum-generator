...
Usage:
  ...
  chdg normalize-gp-drums [options] <file.gp> --track <index>|--tracks <csv>
...
Options:
  ...
  --tracks <csv>           Select multiple tracks for generate, normalize-drums, normalize-gp-drums (example: 3,10)
