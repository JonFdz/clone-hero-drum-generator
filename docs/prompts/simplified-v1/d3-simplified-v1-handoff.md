# Implementation Prompt — D3: design: complete the Simplified V1 implementation handoff

Work in `JonFdz/clone-hero-drum-generator` on issue `<ISSUE_NUMBER>` and branch `design/<ISSUE>-simplified-v1-handoff`.
